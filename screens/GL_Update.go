 ...
 // get the Journal ID for the GL Update 
  ...
  //* but sleep for a few moments to ensure the invoke has completed
   ...
   jstr =`{
    ...
    transactions:=  make(map[string]GLtran)
...
fmt.Println("**************** Starting GL Update***********************")
if len(os.Args) == 1 {
   GLUpdate()
}else{
